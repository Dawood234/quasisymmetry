#!/usr/bin/env python3
"""Build a convergence-certified N2/6-31G parent DMRG reference.
...
def parse_args():
    ...
    parser.add_argument("--bond_length", type=float, default=1.0977)
    parser.add_argument("--basis", default="6-31g")
    parser.add_argument("--point_group", default="D2h")
    ...
    parser.add_argument("--bond_dims", default="100,200,350,500")
    parser.add_argument("--stage_sweeps", default="4,4,6,8")
    parser.add_argument(
        "--reverse_bond_dims",
        default="500,500,350,350,250,250,200,200",
    )
    ...
    parser.add_argument("--calibration_orderings", default="fiedler")
    parser.add_argument("--calibration_threads", default="32")
...
def ensure_checkpoint(args, run_dir):
    ...
    print_stage("Build the D2h-adapted N2/6-31G checkpoint")
    command = [
        args.python,
        "-u",
...
def build_summary(args, run_dir, result_paths, reverse_path):
    ...
    summary = {
        ...
        "basis": args.basis,
        "geometry": {
            "r_NN_Angstrom": args.bond_length,
        },
    ...
    lines = [
        f"# N2/{args.basis} Parent DMRG Reference",
        "",
...
def main():
    ...
    if args.mode in ("production", "all"):
        ...
        build_summary(args, run_dir, result_paths, reverse_path)
        sync_directory(working_store, persistent_store)
